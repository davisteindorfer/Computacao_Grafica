...
Ponto *Cilindro::PrimeiraIntersecao(Ponto &pP0, Vector &pVetor0) {
    ...
    Vector aux = normal;
    aux *= operações::ProdutoEscalar(C0P0, normal);
    Vector v = C0P0 - aux;
    ...
    Ponto* p_teste1 = operações::equacao_reta(t_int1,Raio(pP0, vetorNorm));
    Ponto* p_teste2 = operações::equacao_reta(t_int2,Raio(pP0, vetorNorm));
